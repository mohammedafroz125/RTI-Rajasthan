...
const services: Service[] = [
  ...
  {
    id: '3',
    name: 'Police Department (Rajasthan State Police)',
    icon: FirstIcon,
  ...
  },
  {
    ...
    icon: SOFIcon,
    description: 'RTI for BDA / Rajasthan Housing Board sites, layout approvals, project status.',
    route: '/services/custom-rti',
  },
  {
    id: '8',
...
export const RajasthanServicesGrid: React.FC = () => {
      ...
      <div className="container-responsive max-w-7xl mx-auto px-4">
        <div className="text-center mb-10 md:mb-12">
          <h2 className="text-[32px] sm:text-[36px] md:text-[40px] font-semibold text-gray-900 mb-4">
            Popular RTI Services in Rajasthan
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Expert RTI drafting and filing for all Rajasthan government departments
          </p>
        </div>
